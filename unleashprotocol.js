...
async function unleashprotocol_depositIP(wallet){
    ...
    let txData = {
        to: '0xEf00652511f1743b9C5649d5963057a989826422', 
        data: `0x474cf53d000000000000000000000000b4a7ea1f7874d0c55f19cb6a37aeb3f41a910276${formHexData((wallet.address).substring(2))}${'0'.repeat(64)}`,
...
const main=async(privateKeys)=>{
    ...
    const tasks=privateKeys.map(privateKey=>
        limit(async ()=>{
            ...
            await unleashprotocol_depositIP(wallet) 
        })
     );
